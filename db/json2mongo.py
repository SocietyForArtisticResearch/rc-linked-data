...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Merge JSON data into MongoDB.")
    parser.add_argument(
        'folders', metavar='F', type=str, nargs='+', 
        help="List of folders to search for JSON files"
    )
    
    # Parse arguments
    args = parser.parse_args()
    
    # Call the main function with the list of folder paths
    main(args.folders)